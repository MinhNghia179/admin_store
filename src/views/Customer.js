...
function Customer() {
  ...
  const handleConfirm = (data) => {
    if (data) {
      axios.delete(`http://localhost:5000/customer/delete/${currentCustomer.customerId}`).then(() => { });
    }
  ...
  return (
    <>
      <div className="content content-customer content-product">
        ...
        <CustomerModal show={showModal} handleCloseModal={handleCloseModal} type={type} data={currentCustomer} />
        <Row>
          <Col md="12">
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <div className="list-icon">
                            <BsFillTrashFill onClick={() => handleDeleteCustomer(customer)} />
                            <BsFillPencilFill onClick={() => handleAddNewCustomer("Edit", customer)} />
                          </div>
                        </td>
                      </tr>
                    ))}
